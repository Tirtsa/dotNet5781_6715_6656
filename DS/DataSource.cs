    ...
    public static class DataSource
    {
        ...
        static void InitAllLists()
        {
            ...
            ListFollowingStations = new List<FollowingStations>
            {
                new FollowingStations
                {
                    ...
                    AverageJourneyTime = TimeSpan.FromTicks(new TimeSpan(0, 0, 0, 0, 72).Ticks* 
                        (long)new GeoCoordinate(32.183921, 34.917806).GetDistanceTo(new GeoCoordinate(31.813285, 34.775928))),
                },
                new FollowingStations
                {
                    ...
                    AverageJourneyTime = TimeSpan.FromTicks(new TimeSpan(0, 0, 0, 0, 72).Ticks*
                        (long)new GeoCoordinate(31.813285, 34.775928).GetDistanceTo(new GeoCoordinate(31.95111, 34.819766))),
                },
                new FollowingStations
                {
                    ...
                    AverageJourneyTime = TimeSpan.FromTicks(new TimeSpan(0, 0, 0, 0, 72).Ticks*
                        (long)new GeoCoordinate(31.95111, 34.819766).GetDistanceTo(new GeoCoordinate(31.90281, 34.818922))),
                },
                new FollowingStations
                {
                    ...
                    AverageJourneyTime = TimeSpan.FromTicks(new TimeSpan(0, 0, 0, 0, 72).Ticks*
                        (long)new GeoCoordinate(31.90281, 34.818922).GetDistanceTo(new GeoCoordinate(31.904567, 34.815296))),
                },
                new FollowingStations
                {
                ...
                new FollowingStations
                {
                    ...
                    AverageJourneyTime = TimeSpan.FromTicks(new TimeSpan(0, 0, 0, 0, 72).Ticks*
                        (long)new GeoCoordinate(31.90281, 34.818922).GetDistanceTo(new GeoCoordinate(31.908499, 35.007955))),
                },
                new FollowingStations
                {
                    ...
                    AverageJourneyTime = TimeSpan.FromTicks(new TimeSpan(0, 0, 0, 0, 72).Ticks*
                        (long)new GeoCoordinate(31.878667, 31.878667).GetDistanceTo(new GeoCoordinate(31.95111, 34.819766))),
                },
                new FollowingStations
                {
                    ...
                    AverageJourneyTime = TimeSpan.FromTicks(new TimeSpan(0, 0, 0, 0, 72).Ticks*
                        (long)new GeoCoordinate(31.95111, 34.819766).GetDistanceTo(new GeoCoordinate(31.908499, 35.007955))),
                },
                new FollowingStations
                {
                    ...
                    AverageJourneyTime = TimeSpan.FromTicks(new TimeSpan(0, 0, 0, 0, 72).Ticks*
                        (long)new GeoCoordinate(32.183921, 34.917806).GetDistanceTo(new GeoCoordinate(31.905052, 34.818909))),
                },
                new FollowingStations
                {
                    ...
                    AverageJourneyTime = TimeSpan.FromTicks(new TimeSpan(0, 0, 0, 0, 72).Ticks*
                        (long)new GeoCoordinate(31.905052, 34.818909).GetDistanceTo(new GeoCoordinate(31.914816, 35.023028))),
                }
            };
            ListLineTrips = new List<LineTrip>
            {
                ...
                {
                    LineId = 1,
                    StartTimeRange = new TimeSpan(9,0,0),
                    EndTimeRange = new TimeSpan(11,0,0),
                    Frequency = new TimeSpan(0,10,0)
                },
                new LineTrip
                {
                    LineId = 1,
                    StartTimeRange = new TimeSpan(11,0,0),
                    EndTimeRange = new TimeSpan(16,0,0),
                    Frequency = new TimeSpan(0,20,0)
                },
                new LineTrip
                {
                    LineId = 1,
                    StartTimeRange = new TimeSpan(16,0,0),
                    EndTimeRange = new TimeSpan(20,0,0),
                    Frequency = new TimeSpan(0,45,0)
                },
                new LineTrip
                {
                    LineId = 1,
                    StartTimeRange = new TimeSpan(20,0,0),
                    EndTimeRange = new TimeSpan(9,0,0),
                    Frequency = new TimeSpan(1,0,0)
                },
                new LineTrip
                {
                    LineId = 4,
                    StartTimeRange = new TimeSpan(23,0,0),
                    EndTimeRange = new TimeSpan(9,0,0),
                    Frequency = new TimeSpan(0,10,0)
                },
                new LineTrip
                {
                    LineId = 4,
                    StartTimeRange = new TimeSpan(9,0,0),
                    EndTimeRange = new TimeSpan(23,0,0),
                    Frequency = new TimeSpan(0,10,0)
                },
            };
        }
